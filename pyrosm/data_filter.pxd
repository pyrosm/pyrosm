cdef filter_osm_records(data_records, data_filter, osm_data_type, relation_way_ids, filter_type, bint keep_all=*)
...
cdef filter_relation_indices(relations, osm_keys, data_filter, filter_type, bint keep_all=*)
cdef filter_node_indices(node_arrays, osm_keys, data_filter, filter_type, bint keep_all=*)
